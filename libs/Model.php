...
class Model {
	...
	public function Wilaya() {
        return $this->db->select("SELECT * FROM $this->tbl_wil");
    }

    public function Commune() {
        return $this->db->select("SELECT * FROM $this->tbl_com");
    }
	
	
	function Nbrtostring($id) 
	{
	return $this->db->select("SELECT * FROM structure where id = $id  ");	
	}
